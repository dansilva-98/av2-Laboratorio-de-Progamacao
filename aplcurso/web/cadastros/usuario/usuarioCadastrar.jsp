...
<script>
    ...
    $.ajax({
    type: 'get',
            url: '${pageContext.request.contextPath}/UsuarioVerificarCPF', // sua servlet ou endpoint no backend
            data: {cpf: cpfLimpo},
    ...
    position: 'center',
            ...
            text: 'Informe um e-mail válido. Exemplo: usuario@email.com',
            showConfirmButton: true,
            timer: 4000
    });
    $("#email").focus();
        ...
        success: function (data) {
            ...
            if (data == 1) {
                Swal.fire({
                    ...
                    window.location.href = '${pageContext.request.contextPath}/UsuarioNovo';
                });
